...
export default {
  ...
  应天涉远的卜者: {
    2: attr('speedPct', 6),
    4: {
      title: '进入战斗前，若装备者的速度大于等于[_speed]，使装备者的暴击率提高[cpct]%。装备者施放欢愉技时，使我方全体欢愉度提高[joy]%',
      data: {
  ...
  零号关卡朋克洛德: {
    2: [attr('joy', 8), {
      ...
      data: {
        joy: ({ attr, calc }) => {
          let _joy = calc(attr.joy)
          return _joy < 80 ? 40 : 80
        },
        cdmg: ({ attr, calc }) => {
          let joy = calc(attr.joy)
          return joy < 80 ? 20 : 32
        }
      }
    }]
  ...
  千星荟萃之城: {
    2: [{
      title: '装备者施放追加攻击时，攻击力提高[atkPct]%。当敌方目标被消灭时，我方全体在本场战斗中暴击伤害提高[cdmg]%',
      data: {
        atkPct: 24,
        cdmg: 12
      }
